  ...
  return (
    <ThemeProvider value={colorScheme === 'dark' ? DarkTheme : DefaultTheme}>
      <Stack>
        ...
        <Stack.Screen name="analyze-video" options={{ headerShown: false }} />
        <Stack.Screen name="analysis-result" options={{ headerShown: false }} />
        <Stack.Screen name="create-shortform" options={{ headerShown: false }} />
        ...
        <Stack.Screen name="best-cut" options={{ headerShown: false }} />
