"""
running_pose 2 노트북 로직을 testrun 백엔드에서 호출할 수 있도록 모듈화.

사전 준비:
  1. pip install mediapipe opencv-python pandas numpy google-generativeai
  2. pose_landmarker_heavy.task 파일을 testrun/ 디렉토리에 배치
